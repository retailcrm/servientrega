...
class GenerarGuiaStikerData implements RequestInterface
{
     ...
     * Constructor
     *
     * @var \App\Servientrega\Type\ArrayOfLong $num_GuiaArreglo
     * @var string $ide_CodFacturacion
     * @var int $des_TipoGuia
